...
|---|---|---|---|---|
| **Compulsory** | | | | |
| [Impossible date](https://github.com/FVON-GOOS/qc-flags/discussions/1)<br><sub>QARTOD: Gap Test and Syntax Test; SeaDataNet: Impossible date test</sub> | compulsory | time | before 1990 or in the future → **4**<br>gap longer than the expected interval → **3** | Cutoff year: 1900, 1990 or 2010. |
| [Impossible location](https://github.com/FVON-GOOS/qc-flags/discussions/2)<br><sub>QARTOD: Location Test; SeaDataNet: Impossible location test</sub> | compulsory | position | latitude outside ±90 or longitude outside ±180 → **4** | Settled. |
| [Impossible speed](https://github.com/FVON-GOOS/qc-flags/discussions/3)<br><sub>QARTOD: Location Test (displacement)</sub> | compulsory | position | mobile gear, 8 to 30 knots → **3**<br>over 30 knots → **4** | Confirm the limits: based on GPS accuracy or on fishing speed, and whether they vary by gear. |
| [Global range](https://github.com/FVON-GOOS/qc-flags/discussions/4)<br><sub>QARTOD: Gross Range Test; SeaDataNet: Global range test</sub> | compulsory | temperature, pressure, salinity, conductivity | outside the sensor's range from the manufacturer table → **4**<br>sensor unknown: outside −2.5 to 40 °C, 0 to 11000 dbar, 2 to 42 PSU → **4** | Sensor tables incomplete. Decide whether two inner tiers, calibrated range and operating range, give 2 and 3. |
| [Spike](https://github.com/FVON-GOOS/qc-flags/discussions/5)<br><sub>QARTOD: Spike Test; SeaDataNet: Spike test</sub> | compulsory | temperature, salinity, pressure | difference to both neighbours over 6 °C above 200 m, 2 °C below, or 0.9 PSU → **3** | Absolute differences or standard deviations. No pressure threshold yet. |
| [Stuck value](https://github.com/FVON-GOOS/qc-flags/discussions/6)<br><sub>QARTOD: Flat Line Test; SeaDataNet: Stuck value test</sub> | compulsory | temperature, salinity, pressure | 3 to 5 identical values within 0.001 → **3**<br>more than 5 → **4** | Counts and tolerance for "identical" (0.001 or 0.01 °C). Row counts mislead on fixed gear, where sampling slows at rest; count time instead. |
...
| **Optional** | | | | |
| [Climatology](https://github.com/FVON-GOOS/qc-flags/discussions/8)<br><sub>QARTOD: Climatology Test; SeaDataNet: Regional range test</sub> | optional | temperature, salinity | outside the seasonal mean ± N standard deviations, WOA or regional → **3** | Climatology source and coastal accuracy; our data are meant to improve the climatologies. |
...
| [Drift](https://github.com/FVON-GOOS/qc-flags/discussions/10)<br><sub>SeaDataNet: Sensor drift test</sub> | optional | temperature, salinity | not defined | Decide between long-term calibration drift, which belongs to delayed mode, and a real-time damaged-sensor check on the bottom segment. |
| **Not applied** | | | | |
| [Position on land](https://github.com/FVON-GOOS/qc-flags/discussions/11)<br><sub>SeaDataNet: Position on land test</sub> | not applied | position | on land per ETOPO5 or better → **4** | Kept off because land masks are poor near shore. If a program enables it, 3 rather than 4. |
| **To decide** | | | | |
...
| [Rate of change](https://github.com/FVON-GOOS/qc-flags/discussions/13)<br><sub>QARTOD: Rate of Change Test; SeaDataNet: Gradient test</sub> | to decide | temperature, salinity | change from the previous value over 3 standard deviations of the segment → **3** | Compulsory, optional or not applied. |
